...
public class BasicCalculator extends JFrame
{
    ...
    public BasicCalculator() {
        ...
        // Set size ad layout for the border of calculator
        setSize(400, 500);
        ...
        JPanel buttonPanel = new JPanel(new GridLayout(6, 5)); // Sets the grid to 6 rows and 5 columns
    ...
    private class ButtonClickListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (buttonText.equals("=")) {
                ...
                inputField.setText(inputField.getText() + "\u00b2"); // Adds a superscript 2 (squared) symbol to the input field
                ...
                double parseTerm() {
                    ...
                    while (true) {
                        if (isOperator('*')) {
                            ...
                            x = Math.pow(x,2); // Performs exponential powers
...
/*                             
 Only works with a value 
 BEFORE the pi symbol
*/                               nextChar();
                                 x = x * Math.PI;
                             }
                         else{
